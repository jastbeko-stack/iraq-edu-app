...
class LessonsService {
  ...
  /// Inserts a new lesson row. The `id` is generated by Postgres
  /// (`default gen_random_uuid()`) so callers should pass an empty id and
  /// use the returned [Lesson] when they need the assigned uuid.
  Future<Lesson> insertLesson(Lesson lesson) async {
    final payload = _toRow(lesson)..remove('id');
